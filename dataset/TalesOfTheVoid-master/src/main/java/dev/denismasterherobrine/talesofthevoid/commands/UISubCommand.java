...
import dev.denismasterherobrine.talesofthevoid.ui.TalesOfTheVoidDashboardUI;

import javax.annotation.Nonnull;

/**
 * /tales ui - Open the plugin dashboard UI
 *
...
public class UISubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        context.sendMessage(Message.raw("Opening TalesOfTheVoid Dashboard..."));
        ...
        try {
            ...
            TalesOfTheVoidDashboardUI dashboardPage = new TalesOfTheVoidDashboardUI(playerRef);
