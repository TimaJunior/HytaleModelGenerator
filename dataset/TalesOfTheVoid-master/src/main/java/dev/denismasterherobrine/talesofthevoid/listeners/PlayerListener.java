package dev.denismasterherobrine.talesofthevoid.listeners;
...
public class PlayerListener {
    ...
    public void register(EventRegistry eventBus) {
        ...
        try {
            ...
            LOGGER.at(Level.INFO).log("[Tales of the Void] Registered PlayerConnectEvent listener");
        } catch (Exception e) {
            LOGGER.at(Level.WARNING).withCause(e).log("[Tales of the Void] Failed to register PlayerConnectEvent");
        }

        // PlayerDisconnectEvent - When a player disconnects
        try {
            eventBus.register(PlayerDisconnectEvent.class, this::onPlayerDisconnect);
            LOGGER.at(Level.INFO).log("[Tales of the Void] Registered PlayerDisconnectEvent listener");
        } catch (Exception e) {
            LOGGER.at(Level.WARNING).withCause(e).log("[Tales of the Void] Failed to register PlayerDisconnectEvent");
        }
    }
    ...
    private void onPlayerConnect(PlayerConnectEvent event) {
        ...
        LOGGER.at(Level.INFO).log("[Tales of the Void] Player %s connected to world %s", playerName, worldName);
    ...
    private void onPlayerDisconnect(PlayerDisconnectEvent event) {
        ...
        LOGGER.at(Level.INFO).log("[Tales of the Void] Player %s disconnected", playerName);
